 ...
 * 2018-06-24T19:32:58.083+08:00
 * Generated source version: 2.5.9
 * 
 */
@WebServiceClient(name = "helloWorldWs", 
                  wsdlLocation = "http://localhost:8080/cxf_spring/fkservice/fkjava?wsdl",
...
public class HelloWorldWs extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/cxf_spring/fkservice/fkjava?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldWs.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/cxf_spring/fkservice/fkjava?wsdl");
        }
        WSDL_LOCATION = url;
    }
