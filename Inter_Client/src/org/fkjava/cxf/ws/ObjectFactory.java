...
public class ObjectFactory {
    ...
    private final static QName _GetAllCats_QNAME = new QName("http://ws.cxf.fkjava.org/", "getAllCats");
    private final static QName _GetAllCatsResponse_QNAME = new QName("http://ws.cxf.fkjava.org/", "getAllCatsResponse");
    private final static QName _SayHiResponse_QNAME = new QName("http://ws.cxf.fkjava.org/", "sayHiResponse");
    private final static QName _GetCatsByUserResponse_QNAME = new QName("http://ws.cxf.fkjava.org/", "getCatsByUserResponse");
    private final static QName _SayHi_QNAME = new QName("http://ws.cxf.fkjava.org/", "sayHi");
    private final static QName _GetCatsByUser_QNAME = new QName("http://ws.cxf.fkjava.org/", "getCatsByUser");
    ...
    /**
     * Create an instance of {@link GetAllCatsResponse.Return }
     * 
     */
    public GetAllCatsResponse.Return createGetAllCatsResponseReturn() {
        return new GetAllCatsResponse.Return();
    }
    ...
    /**
     * Create an instance of {@link GetAllCatsResponse.Return.Entry }
     * 
     */
    public GetAllCatsResponse.Return.Entry createGetAllCatsResponseReturnEntry() {
        return new GetAllCatsResponse.Return.Entry();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.cxf.fkjava.org/", name = "getAllCats")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.cxf.fkjava.org/", name = "getAllCatsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.cxf.fkjava.org/", name = "sayHiResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.cxf.fkjava.org/", name = "getCatsByUserResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.cxf.fkjava.org/", name = "sayHi")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.cxf.fkjava.org/", name = "getCatsByUser")
